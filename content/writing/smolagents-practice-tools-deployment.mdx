...
This essay is based on Episode 4 of the HuggingFace Agents Course Podcast. **[Listen on Spotify](https://open.spotify.com/episode/6rhafPED1yiM6yx6wssgfL)**

<iframe
  style={{ borderRadius: "12px" }}
  src="https://open.spotify.com/embed/episode/6rhafPED1yiM6yx6wssgfL?utm_source=generator"
  width="100%"
  height="232"
  frameBorder="0"
...
**Deploying an agent?** What platform are you using? What model? Email maros@marosjanco.com or tweet [@marosjanco](https://twitter.com/marosjanco). I want to learn what works in the wild.
