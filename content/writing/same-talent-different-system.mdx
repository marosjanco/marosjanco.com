...
![Two engineers, the same talent, different systems. Left: overwhelmed by a support queue, a Friday-5pm deadline, bug and urgent tickets, pinging notifications. Right: relaxed at a multi-monitor setup with AI agents, an ideas board, and worktrees 1 through N. Caption: it's the system, not the talent.](/writing/same-talent-different-system.jpg)
