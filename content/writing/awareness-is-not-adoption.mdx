...
date: "2026-06-07"
summary: "Your people know the AI tools exist and the licences are paid for. Nevertheless, the AI transition across the teams may stall if the reward system and product planning are not adapted for it. Product planning methodologies should not clash with exploring, leveraging and demoing AI tools usage."
tags: ["ai-adoption", "teams", "leadership", "change-management", "ai"]
draft: false
---

Across your team(s), can you say how actively and how regularly people use these tools, what's the leverage, on what work, how are the tools shared across, and whether they have had a real opportunity to explore and show what changed? If those have no answer, "we're adopting AI" is a hope, not a status. The change needs to be structural and not "we bought the licences".

## Why it stalls

Teams are measured on *what* gets done — the milestone, the ticket — and less on *how*. There are various project development methodologies but how do they account for the leverage and usage of AI tools? AI tooling stays often optional, and optional against a deadline means later. It's an exploration-versus-exploitation problem, which is policy-based, not motivational: exploiting the known workflow ships predictably this sprint; exploring a coding agent or an automation has an uncertain payoff and a certain cost, paid from the same hours you owe the roadmap. Make exploration optional and you have decided against it.

This is not the team being incurious. You may have enthusiastic AI early adopters in your company who also showcase the impact of AI tooling on their work, but does this scale sufficiently to the whole team and across the departments (marketing, accounting, customer support, engineering teams)?
...
- 78% of AI-using employees are on tools they brought themselves, while 60% of leaders concede their company has no plan to put AI to use — the two-sided gap, measured. (Microsoft–LinkedIn *Work Trend Index*, 2024)
