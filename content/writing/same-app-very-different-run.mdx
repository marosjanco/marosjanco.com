...
| **Time ratio ²** | ~0.5× ᵉ | ~1.7× ᵉ | 1× | ~2.0× | ~2.9× |
| **Token ratio ²** | ~0.6× ᵉ | ~0.7× ᵉ | 1× | ~1.7× | ~3.6× |

¹ Chase AI blog, April 2026 — simple projects, same model, per-session context tokens.
...
- **Jamie Telin, *IT Chronicles* (June 2026)** ran OpenSpec vs Spec Kit on GPT-5.2 across two test runs of a chat-support app. Spec Kit / OpenSpec token ratios: 2.09× (test 1: 120,947 vs 57,740) and 1.97× (test 2: 181,040 vs 91,729). Within 5% of the 1.69× cell. OpenSpec also used ~20% fewer assistant turns and ~25% fewer tool calls.
