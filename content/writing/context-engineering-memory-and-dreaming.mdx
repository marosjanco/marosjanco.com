---
title: "Context engineering, memory, and 'dreaming'"
date: "2026-06-23"
...
I watched a talk from Anthropic's AI DevCon — Lamish, from their applied AI team — on where context engineering has landed in the last year. It's a good map of the territory, and it lines up with what I keep running into when I take agent systems from demo to production: the model intelligence is rarely the bottleneck. The context around it is.
...
An audience member asked the obvious question: *at what point are we just reinventing databases?* The honest answer in the talk was basically "yes, and on purpose." Having learned which primitives actually matter, they're hardening them into the harness deterministically instead of leaving them to the model. That's the right instinct. **The skill is drawing the boundary** between what the agent decides autonomously and what the harness enforces mechanically. Versioning and concurrency are not things you want an LLM improvising.
...
- **Add guardrails only when scale forces them** — many agents, long-running workspaces, complex domains. Then versioning, concurrency control, and permissioning stop being over-engineering and become the thing standing between you and a fleet that poisons its own memory.
...
*Based on Lamish's talk at Anthropic's AI DevCon — [video here](https://www.youtube.com/watch?v=tTcxVv8HHNw). The framing of the production guardrails and the "dreaming" process is theirs; the opinions about where they hold up are mine.*
