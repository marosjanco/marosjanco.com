---
title: "When agents dream: out-of-band memory and the evolution of agentic memory"
date: "2026-06-23"
summary: "How agentic memory evolved — from CLAUDE.md to memory-as-a-filesystem, then from in-band learning to an out-of-band consolidation pass Anthropic calls 'dreaming' — with a production engineer's read on which parts are real leverage and which are classic database primitives in a trench coat."
